  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative w-full h-96 my-6 col-span-1 sm:col-span-2 lg:col-span-4 overflow-hidden">
          <Image
            src="https://www.tunisair.com/sites/default/files/inline-images/9ribmeni_0.jpg"
            alt="Special Offer"
            fill
            className="object-cover"
            sizes="100vw"
            priority
          />
          <div className="absolute w-44 h-44 top-0 right-12">
   <Image
...
<div className="absolute top-4 left-4 max-w-md p-2">
  <span className="uppercase text-white font-semibold">Fidelys</span>
          ...
          <div className="absolute bottom-4 left-4 bg-gradient-to-r from-black/40 to-transparent text-white p-4 max-w-md">
            <h3 className="text-2xl font-bold">Your satisfaction is our priority</h3>
            <Link href="/" className="text-sm mt-1 w-full">
